...
<h3>Hocbigg - [Field]</h3>
<p>
  Path to a free self-taught education in [Field]!
</p>
</div>
...
The [Field] curriculum is a **complete education in [Field]** using online materials.
It's not merely for career training or professional development.
It's for those who want a proper, *well-rounded* grounding in concepts fundamental to all computing disciplines,
and for those who have the discipline, will, and (most importantly!) good habits to obtain this education largely on their own,
but with support from a worldwide community of fellow learners.

It is designed according to the degree requirements of undergraduate [Field] majors, minus general education (non-CS) requirements,
...
- *Intro*: for students to try out [Field] and see if it's right for them
- *Core*: corresponds roughly to the first three years of a [Field] curriculum, taking classes that all majors would be required to take
- *Advanced*: corresponds roughly to the final year of a [Field] curriculum, taking electives according to the student's interests
- *Final Project*: a project for students to validate, consolidate, and display their knowledge, to be evaluated by their peers worldwide

**Duration**. It is possible to finish within about 1 years if you plan carefully and devote roughly 20 hours/week to your studies.
...
After completing **every required course** in Core [Field], students should choose a subset of courses from Advanced [Field] based on interest.
...
After you've completed Core [Field] and the parts of Advanced [Field] relevant to you,
